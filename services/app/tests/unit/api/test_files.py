...
class TestViewArtifact:
    ...
    async def test_view_pdf_returns_correct_mime_type(
        ...
        with patch(
            ...
            response = await async_client.get(
                "/api/files/uploads/artifacts/art-001/view"
            )

        assert response.status_code == 200
        assert response.headers["content-type"] == "application/pdf"
        # Should NOT have content-disposition: attachment
        assert "attachment" not in response.headers.get(
            "content-disposition", ""
        )

    async def test_view_docx_returns_correct_mime_type(
        self, async_client, tmp_path
    ):
        ...
        with patch(
            ...
            response = await async_client.get(
                "/api/files/uploads/artifacts/art-002/view"
            )
    ...
    async def test_view_pptx_returns_correct_mime_type(
        self, async_client, tmp_path
    ):
        ...
        with patch(
            ...
            response = await async_client.get(
                "/api/files/uploads/artifacts/art-003/view"
            )
    ...
    async def test_view_artifact_not_found(self, async_client):
        ...
        with patch(
            ...
            response = await async_client.get(
                "/api/files/uploads/artifacts/nonexistent/view"
            )

        assert response.status_code == 404
        assert "Artifact not found" in response.json()["detail"]

    async def test_view_artifact_file_missing_on_disk(
        self, async_client
    ):
        ...
        with patch(
            ...
            response = await async_client.get(
                "/api/files/uploads/artifacts/art-004/view"
            )

        assert response.status_code == 404
        assert "File not found" in response.json()["detail"]

    async def test_view_unknown_type_falls_back_to_octet_stream(
        self, async_client, tmp_path
    ):
        ...
        with patch(
            ...
            response = await async_client.get(
                "/api/files/uploads/artifacts/art-005/view"
            )
...
class TestDownloadArtifact:
    ...
    async def test_download_returns_attachment_header(
        self, async_client, tmp_path
    ):
        ...
        with patch(
            ...
            response = await async_client.get(
                "/api/files/uploads/artifacts/art-001"
            )
