...
export const defaultLayouts: ResponsiveLayouts = {
  lg: [
    ...
    { i: 'study', x: 0, y: 8, w: 12, h: 6 },
    { i: 'deadlines', x: 0, y: 14, w: 12, h: 4 },
    { i: 'activity', x: 0, y: 18, w: 8, h: 4 },
    { i: 'upload', x: 8, y: 18, w: 4, h: 5 },
    { i: 'courses', x: 0, y: 23, w: 12, h: 5 },
  ],
  sm: [
    { i: 'streak', x: 0, y: 0, w: 12, h: 2 },
    { i: 'exams', x: 0, y: 2, w: 12, h: 3 },
    { i: 'gamification', x: 0, y: 5, w: 12, h: 5 },
    { i: 'study', x: 0, y: 10, w: 12, h: 6 },
    { i: 'deadlines', x: 0, y: 16, w: 12, h: 3 },
    { i: 'activity', x: 0, y: 19, w: 12, h: 4 },
    { i: 'upload', x: 0, y: 23, w: 12, h: 5 },
    { i: 'courses', x: 0, y: 28, w: 12, h: 5 },
  ],
}
